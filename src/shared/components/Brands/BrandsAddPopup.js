...
import AddNewBrands from "../Brands/AddNewBrands";
...
export default function AlertDialog1(props) {
  ...
  return (
    <div>
      ...
      >
        <AddNewBrands updstate = {closepop} closii={handleClose} previos={props.previos} module={props.moduulee} update={returnobj}/>
