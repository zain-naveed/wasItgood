...
import { BrandsUpdate } from "../../services/BrandsUpdate";
import CircularProgress from "@mui/material/CircularProgress";
import TextField from "@mui/material/TextField";
import MenuItem from "@mui/material/MenuItem";
import { notify } from "../../utils/notify";
import { Childupdate } from "../../services/ChildApiiAll";
import { SubChildUpdateapi } from "../../services/Sub_Child";
...
function ReportUpdate(props) {
  ...
  const handleSubmit = () => {
    ...
    if (props.module === "child") {
      Childupdate(data?.id, obj)
        .then(({ data }) => {
